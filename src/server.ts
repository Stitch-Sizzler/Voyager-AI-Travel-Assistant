...
export class TravelAgent extends AIChatAgent {
  async onChatMessage() {
    ...
    const result = streamText({
      ...
      system:
        "You are a helpful travel assistant. You can check the weather and recommend top attractions for any city. Always use your tools to get the information before answering.",
      ...
      tools: {
        ...
        getAttraction: tool({
          ...
          execute: async ({ city }) => {
            ...
            const attraction =
              attractions[normalizedCity] || "The Historic Downtown Square";
